      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-sm text-gray-500">
          <button
            ...
            className="font-medium text-gray-600 hover:text-gray-900 transition-colors py-1 px-2 rounded-lg hover:bg-gray-100"
          >
            Projects
          </button>
          ...
          <button
            ...
            className="font-medium text-gray-600 hover:text-gray-900 transition-colors py-1 px-2 rounded-lg hover:bg-gray-100 truncate max-w-[200px]"
          >
            {project.title}
          </button>
          <span className="text-gray-300">/</span>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1.5">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-md text-[11px] font-bold bg-gray-100 text-gray-800 border border-gray-200 uppercase tracking-wider">
                {subtask.taskType}
              </span>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              <div className="relative flex-1 w-full">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 text-xs bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-gray-400 focus:bg-white transition-colors text-gray-800"
                />
              </div>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <select
                  ...
                  className="px-3 py-2 text-xs bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-gray-400 font-semibold text-gray-700"
                >
                ...
                return (
                  <Card
                    ...
                    className={`p-4 sm:p-5 bg-white border rounded-2xl shadow-2xs transition-all ${
                      isAssigned
                        ? 'border-gray-400 bg-gray-50/50 shadow-xs ring-1 ring-gray-300'
                    ...
                    <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                      ...
                      <div className="flex items-start gap-3.5 flex-1 min-w-0">
                        <div className="relative shrink-0 mt-0.5">
                          ...
                          {isAssigned && (
                            <span className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-gray-900 text-white flex items-center justify-center ring-2 ring-white">
                        ...
                        <div className="min-w-0 space-y-1.5 flex-1">
                          <div className="flex flex-wrap items-center gap-2">
                            <h3
                              ...
                              className="text-sm font-bold text-gray-900 hover:text-black cursor-pointer transition-colors"
                            >
                              {e.fullName}
                            </h3>

                            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10.5px] font-extrabold bg-gray-100 text-gray-800 border border-gray-200">
                      ...
                      <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-start gap-2.5 shrink-0 w-full sm:w-auto pt-3 sm:pt-0 border-t sm:border-t-0 border-gray-100">
                        {isAssigned ? (
                          ...
                          <button
                            onClick={() => assign(e.id)}
                            className="inline-flex items-center gap-1.5 px-4 py-2 bg-gray-900 hover:bg-black text-white text-xs font-bold rounded-xl shadow-2xs hover:shadow-sm transition-all"
                          >
                        ...
                        <button
                          onClick={() => onNavigate(`/admin/editor/${e.id}`)}
                          className="text-[11px] text-gray-400 hover:text-gray-900 font-medium inline-flex items-center gap-1 transition-colors"
                        >
        ...
        <div className="lg:col-span-4 space-y-4 sticky top-20">
          ...
          <Card className="p-5 bg-white border border-gray-100 rounded-2xl shadow-2xs space-y-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
              ...
              <span className="text-[11px] font-bold text-gray-800 bg-gray-100 px-2 py-0.5 rounded-full">
            ...
            <div className="pt-2 border-t border-gray-100">
              <button
                onClick={() => onNavigate(`/admin/projects/${projectId}`)}
                className="w-full py-2.5 px-4 bg-gray-900 hover:bg-black text-white text-xs font-bold rounded-xl shadow-2xs transition-all text-center flex items-center justify-center gap-2"
              >
          ...
          <Card className="p-5 bg-white border border-gray-100 rounded-2xl shadow-2xs space-y-3.5 text-xs">
            ...
            <div>
              ...
              <span className="inline-block font-semibold px-2 py-0.5 rounded bg-gray-100 text-gray-800 text-[11px]">
                {subtask.status}
              </span>
            </div>
          </Card>
